      ...
      <div className="mx-auto max-w-6xl">
        ...
        <Reveal className="mt-16">
          <a
            ...
            className="group block border border-line bg-surface p-8 transition-[transform,box-shadow] duration-200 ease-out hover:-translate-y-1 hover:shadow-md motion-reduce:transition-none motion-reduce:hover:translate-y-0 sm:p-12 lg:p-16"
          >
